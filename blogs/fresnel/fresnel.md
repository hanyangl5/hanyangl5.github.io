...
[Gulbrandsen14](https://jcgt.org/published/0003/04/03/) gaves an artist friendly approxmiztion for metallic fresnel. He made an remap of IOR to reflectivity $r$ and edgetint $g$ derived from Fresnal Equation. But it is RGB based rendering, didn't account the spectual distribution.
